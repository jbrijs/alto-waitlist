          ...
          <div className="w-full max-w-md flex flex-col gap-4">
            <div className="panel relative overflow-hidden p-8">
              ...
              <div className="flex flex-col gap-6">
                ...
                {/* What happens next */}
                <div className="rounded-lg px-4 py-4 flex flex-col gap-3 bg-accent border border-primary/20">
                  <p className="text-[10px] font-semibold tracking-[0.18em] uppercase text-primary font-mono">
                    What happens next
                  </p>
                  <ul className="flex flex-col gap-2">
                    {[
                      ...
                      <li key={item} className="flex items-start gap-2.5 text-sm text-gray-600">
                        <span className="mt-[3px] w-1.5 h-1.5 rounded-full shrink-0 bg-primary" />
                        {item}
                      </li>
                    ))}
                  </ul>
